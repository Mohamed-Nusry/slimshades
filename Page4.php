...
<div class="container">
  ...
  $sql="SELECT p_id,p_order,p_name,p_details,p_image,p_quantity,p_date FROM tbl_products LIMIT 18,6 ";
...
<nav aria-label="...">
  <ul class="pagination justify-content-center">
    <li class="page-item ">
      <a class="page-link" href="page3.php" tabindex="-1">Previous</a>
    </li>
    <li class="page-item "><a class="page-link" href="Gallery.php">1</a></li>
    <li class="page-item ">
      <a class="page-link " href="page2.php">2 <span class="sr-only">(current)</span></a>
    </li>
    <li class="page-item "><a class="page-link" href="page3.php">3</a></li>
    <li class="page-item ">
      <li class="page-item active"><a class="page-link" href="page4.php">4</a></li>
      <li class="page-item ">
        <li class="page-item"><a class="page-link" href="page5.php">5</a></li>
        <li class="page-item ">
          <a class="page-link" href="page5.php">Next</a>
        </li>
      </ul>
    </nav>
