...
<div class="container">
  ...
  $sql="SELECT p_id,p_order,p_name,p_details,p_image,p_quantity,p_date FROM tbl_products LIMIT 6,6 ";
...
<nav aria-label="...">
  <ul class="pagination justify-content-center">
    <li class="page-item ">
      <a class="page-link" href="Gallery.php" tabindex="-1">Previous</a>
    </li>
    <li class="page-item "><a class="page-link" href="Gallery.php">1</a></li>
    <li class="page-item active">
      <a class="page-link active" href="page2.php">2 <span class="sr-only">(current)</span></a>
    </li>
